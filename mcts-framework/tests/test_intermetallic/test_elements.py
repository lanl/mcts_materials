...
def test_metal_4d_edges():
    assert elements.metal_moves(40) == [40, 41, 72, 22]  # Zr
    assert elements.metal_moves(48) == [47, 48, 80, 30]  # Cd


def test_metal_4d_middle():
    # Ru (44): 43, 44, 45, 76 (+32), 26 (-18)
    assert elements.metal_moves(44) == [43, 44, 45, 76, 26]


def test_metal_5d_edges():
    assert elements.metal_moves(72) == [72, 73, 40]   # Hf
    assert elements.metal_moves(80) == [79, 80, 48]   # Hg


def test_metal_5d_middle():
    # W (74): 73, 74, 75, 42 (-32)
    assert elements.metal_moves(74) == [73, 74, 75, 42]
